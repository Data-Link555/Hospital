  ...
  <div align="center" style="padding: 70px;">
    <table>
        <tr style="background-color: black;">
            <th style="padding: 10px; font-size:12px; color:white;">Doctor Name</th>
            <th style="padding: 10px; font-size:12px; color:white;">Date</th>
            <th style="padding: 10px; font-size:12px; color:white;">Message</th>
            <th style="padding: 10px; font-size:12px; color:white;">Stauts</th>
            <td style="padding: 10px; font-size:12px; color:white;">Cancel Appointment</td>
        </tr>
