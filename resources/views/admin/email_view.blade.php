...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
     ...
     <div class="continar" align="center" style="padding-top: 100px;">
      ...
      @endif
        ...
        <input type="text" style="color:black;" name="greeting" placeholder=""required="">
         ...
         <label>Body</label>
            ...
            <input type="text" style="color:black;" name="body" placeholder="" required="">
         </div>
        ...
        <div style="padding: 15px;">
            ...
            <input type="text" style="color:black;" name="End Part" placeholder="" required=""> 
            </div>
